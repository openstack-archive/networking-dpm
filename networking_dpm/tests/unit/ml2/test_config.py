...
class TestDPMConfig(base.BaseTestCase):
    ...
    @staticmethod
    def _get_physical_adapter_mappings():
        return CONF.dpm.physical_adapter_mappings
    ...
    def test_parse_interface_mappings_bad(self):
        ...
        for mapping in bad_mappings:
            ...
            # CONF is not a callable. Therefore the wrapper func exists
