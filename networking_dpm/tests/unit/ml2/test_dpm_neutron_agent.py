...
class TestPhysnetMapping(base.BaseTestCase):
    ...
    def test_create_mapping(self):
        ...
        mapping = dpm_agt.PhysicalNetworkMapping(cpc)
    ...
    def test_create_mapping_invalid_adapter_type(self):
        ...
        cpc = fake_zhmcclient.get_cpc(hmc)
        self.assertRaises(SystemExit, dpm_agt.PhysicalNetworkMapping, cpc)

    def test_create_mapping_adapter_not_exists(self):
        conf_mapping = {'physnet1': {'not_exists': None}}
        cfg.CONF.set_override('physical_adapter_mappings', conf_mapping,
                              group='dpm')
        hmc = {"cpcs": [{
            "object-id": "cpcpid",
    ...
    def test_create_mapping_no_config(self):
        ...
        self.assertRaises(SystemExit, dpm_agt.PhysicalNetworkMapping,
                          mock.Mock())

    def test_create_mapping_multiple_adapters(self):
