...
class TestDPMMain(base.BaseTestCase):
    ...
    def _test_parse_interface_mappings_good(self, mappings, expected):
        ...
        self.assertEqual(expected, dpm_agt.parse_interface_mappings())
    ...
    def test_parse_interface_mappings_bad(self):
        ...
        for mapping in bad_mappings:
            ...
            self.assertRaises(ValueError, dpm_agt.parse_interface_mappings)
    ...
    def _get_client(self):
        #TODO(andreas_s): replace with a mock!
        session = zhmcclient.Session('9.152.133.162', 'pedebug', 'password')
        client = zhmcclient.Client(session)
        return client

    def _get_fake_cpc(self):
        #TODO(andreas_s): replace with a mock!
    ...
    def test_validate_interface_mappings(self):
        ...
        dpm_agt.validate_interface_mappings(mapping, self._get_fake_cpc())
