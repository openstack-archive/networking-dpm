...
class TestFakeZHMC(base.BaseTestCase):
    ...
    def test_fakehmc_full(self):
        ...
        adapter_ports = [{'element-id': 'id0'}, {'element-id': 'id1'}]
        ...
        port0 = adapter0.ports.find(**{'element-id': 'id0'})
        self.assertEqual('id0', port0.get_property('element-id'))
        port1 = adapter0.ports.find(**{'element-id': 'id1'})
        self.assertEqual('id1', port1.get_property('element-id'))
