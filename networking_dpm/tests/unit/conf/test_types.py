...
from networking_dpm.conf.types import MultiStringWithKwargsType
...
class TestMultiStringWithKwargsType(base.BaseTestCase):

    def setUp(self):
        super(TestMultiStringWithKwargsType, self).setUp()
        self.mm_type = MultiStringWithKwargsType()
