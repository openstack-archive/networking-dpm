...
def parse_adapter_mappings():
    return cfg.CONF.dpm.adapter_interface_mappings


def get_physnet_adapter_map(interface_mappings, cpc):
    mappings = {}
...
def main():
    ...
    interface_mappings = parse_adapter_mappings()
    physnet_adapter_map = get_physnet_adapter_map(interface_mappings, cpc)
