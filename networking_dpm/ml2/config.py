...
dpm_opts = [
    DictOfDictsOpt('physical_adapter_mappings',
                   ...
                   help=_("List of "
                          ...
                          "This configuration tells the Neutron DPM agent "
                          "which physical network is accessible via which "
                          "network adapters/ports. Only a single adapter/port "
                          "combination is supported by one physical network. "
                          "All physical networks listed in "
                          "ml2.network_vlan_ranges on the "
